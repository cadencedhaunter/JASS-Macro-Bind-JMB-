...
Event-binding automatization in JASS.
  ...
  For compatibility purposes, this code does not use any other libraries or other defined macroses like 'void','int','bool', 'float'. Requires NewGen World Editor (because it uses cJass and vJass features).
